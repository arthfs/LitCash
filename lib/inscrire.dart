...
TextStyle Field_label_style = TextStyle(fontSize: 15);

class Inscrir extends StatefulWidget {
  const Inscrir({Key? key}) : super(key: key);

  @override
  _InscrirState createState() => _InscrirState();
}
...
class _InscrirState extends State<Inscrir> {
  ...
  double fieldheight = 50, fieldwidth = 275;
                  ...
                  child: Form(
                      ...
                      child: Column(
                          ...
                          children: [
                            Container(
                              ...
                              child: TextFormField(
                                decoration: InputDecoration(
                                    floatingLabelStyle: Field_label_style,
                            ...
                            Container(
                              padding: EdgeInsets.only(bottom: fieldspace + 5),
                              width: fieldwidth,
                              //height: 50,
                              child: Center(
                                  // color: Colors.red,
                            ...
                            Container(
                              ...
                              child: TextFormField(
                                ...
                                validator: (x) {
                                  ...
                                  if (result.compareTo('invalid-email') == 0)
                                    return 'Email invalide';

                                  if (result
                                          .compareTo('email-already-in-use') ==
                                      0) return 'Cet email est deja utilise';
                                  return null;
                                },
                              ),
                            ),
                            ...
                            Container(
                              ...
                              child: TextFormField(
                                ...
                                validator: (x) {
                                  ...
                                  if (x.compareTo(_passwordcontroller.text) !=
                                      0)
